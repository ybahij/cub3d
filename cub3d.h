...
int						process_color_values(char *path, t_player *player,
							char color);
int						check_color_validity(char *path, t_player *player,
							char color);
...
void					load_texter(t_texture *texture, t_player *player,
							char *path);
...
void					move_player_1(t_player *player, float new_px,
							float new_py);
